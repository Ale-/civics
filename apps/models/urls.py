...
urlpatterns = [
    ...
    url(r'^crea/iniciativa$', views.InitiativeCreate.as_view(), name="create_initiative_staff"),
    url(r'^crea/tu-iniciativa$', views.OwnInitiativeCreate.as_view(), name="create_initiative"),
